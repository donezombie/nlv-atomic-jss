...
var AtomicStyled = /** @class */ (function () {
    ...
    AtomicStyled.prototype.setupStyles = function (stylesArg, colorsArg) {
        var ultilize = {};
        ...
        var genColor = function () {
            return Object.entries(colors).reduce(function (nextObj, el) {
                ...
                nextObj["color".concat(key.charAt(0).toUpperCase() + key.slice(1, key.length))] = { color: value };
                nextObj["borderColor".concat(key.charAt(0).toUpperCase() + key.slice(1, key.length))] = { borderColor: value };
                return nextObj;
            }, {});
        };
        for (var i = 1; i <= 100; i++) {
        ...
        arr.forEach(function (el) {
            ...
            properties["mobile-".concat(el.name)] = (_c = {}, _c[el.property] = el.value, _c);
        });
    ...
    AtomicStyled.prototype.classes = function (arrStyles) {
        return (0, aphrodite_1.css)(arrStyles.map(function (style) { return styles[style]; }));
    };
    return AtomicStyled;
}());
